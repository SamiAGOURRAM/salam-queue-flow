...
export default function PatientOnboarding() {
  ...
  const [step, setStep] = useState<"welcome" | "medical-intake">("welcome");
        ...
        {step === "welcome" ? (
          <>
            ...
            <div className="space-y-2">
              <Button
                onClick={() => setStep("medical-intake")}
          ...
          <>
            <div className="mb-6">
              ...
              <p className="text-sm text-muted-foreground">
                Share allergies, active conditions, and current medications so clinics can treat you safely from day one.
              </p>
            </div>
            ...
            <div className="grid gap-2 sm:grid-cols-2">
              ...
              <Button
                onClick={handleComplete}
                className="h-11 rounded-[4px] bg-foreground text-background hover:bg-foreground/90 font-medium"
              >
