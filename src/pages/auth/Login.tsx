          ...
          <div className="hidden lg:block space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-xl text-gray-600 leading-relaxed">
                Connect with top healthcare providers, book instantly, and manage your health journey with ease.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-4 group">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Verified healthcare providers</p>
                </div>
              </div>
            </div>
          </div>
