...
import { Activity, ArrowLeft, UserPlus, Mail, Trash2, Users } from "lucide-react";
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-background">
        <Card className="w-full max-w-md">
          ...
          <CardContent>
            <Button onClick={() => navigate("/clinic/dashboard")} className="w-full">
              Go to Dashboard
            </Button>
          </CardContent>
        </Card>
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <h1 className="hidden md:block text-lg font-semibold text-gray-700">Team Management</h1>
            </div>
            <Button 
              variant="outline" 
      ...
      <main className="container mx-auto px-6 py-8 max-w-5xl">
        <div className="mb-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="space-y-1">
            ...
            <p className="text-base text-gray-500">Manage staff members and send invitations</p>
          </div>
